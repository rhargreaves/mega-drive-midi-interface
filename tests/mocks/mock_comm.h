...
extern void __real_comm_demo_write(const u8* data, u16 length);
...
extern void __real_comm_megawifi_write(const u8* data, u16 length);
extern void __real_comm_init(void);
extern void __real_comm_write(const u8* data, u16 length);
...
#define expect_usb_sent_bytes(data, length) _expect_usb_sent_bytes(data, length, __FILE__, __LINE__)
