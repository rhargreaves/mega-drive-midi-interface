...
{
    PitchCents pc = pc_bend(50, 0, 0x2000);
...
{
    PitchCents pc = pc_bend(50, 0, 0x4000);
...
{
    PitchCents pc = pc_bend(50, 0, 0x3000);
...
{
    PitchCents pc = pc_bend(50, 0, 0x1800);
...
{
    PitchCents pc = pc_bend(50, 0, 0x2800);
...
{
    PitchCents pc = pc_bend(50, 25, 0x1800);
...
{
    PitchCents pc = pc_bend(50, 80, 0x1800);
...
{
    PitchCents pc = pc_bend(50, 25, 0x4000);
...
{
    PitchCents pc = pc_bend(50, 80, 0x4000);
