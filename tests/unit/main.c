...
int main(void)
{
    const struct CMUnitTest tests[] = { cmocka_unit_test(
        ...
        cmocka_unit_test_setup_teardown(
            test_midi_increments_beat_every_24th_clock, test_midi_setup,
            test_midi_setup),
        cmocka_unit_test_setup_teardown(
            test_midi_start_resets_clock, test_midi_setup, test_midi_setup),
        cmocka_unit_test(test_midi_position_sets_beat),
        cmocka_unit_test(test_midi_timing_sets_bar_number),
        cmocka_unit_test_setup_teardown(
            test_midi_increments_clocks, test_midi_setup, test_midi_setup),
